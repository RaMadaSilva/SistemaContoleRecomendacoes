...
namespace ControleRecommads.Test.FakeRepositories
{
    public class FakeReceivedRepository : IRepositoryBase<ReceivedRecommendation>
    {
        private List<ReceivedRecommendation> receivedRecommendations = new()
        {
            ...
            new ReceivedRecommendation(new("Henrique",  "Sebastião", 555555555, "Zango"), new DateTime(2023, 04, 19), new("Zango", "Zango")),
            new ReceivedRecommendation(new("Feliciana",  "João", 666666666, "Prenda"), new DateTime(2023, 02, 19), new("Prenda", "Prenda")),
